...
exports.runCertifiedAiComputeBenchmark = runCertifiedAiComputeBenchmark;
...
function runCertifiedAiComputeBenchmark(map, options = {}) {
    ...
    const cycleLibrary = (0, cycle_library_js_1.generateDiverseHamiltonianCycles)(workingMap, options.cycleLibraryOptions ?? DEFAULT_CYCLE_LIBRARY_OPTIONS);
...
function buildSelectionOptions(variant, cacheMode, patchOptions = {}) {
    const patchMutationCandidateCache = patchOptions.patchMutationCandidateCache ?? new patch_mutation_candidate_cache_js_1.PatchMutationCandidateCache();
