...
exports.defaultCycleScoreWeights = void 0;
exports.computeCycleFeatures = computeCycleFeatures;
exports.scoreCycleFeatures = scoreCycleFeatures;
exports.compareCandidateCycles = compareCandidateCycles;
const hamiltonian_certificate_js_1 = require("./hamiltonian-certificate.js");
const graph_js_1 = require("./graph.js");
const MISSING_FEATURE_PENALTY = 1_000_000;
exports.defaultCycleScoreWeights = {
    pathLen: 8,
...
function computeCycleFeatures(state, oldCycle, candidateCycle) {
    const graph = (0, graph_js_1.hydrateGraph)(state.map.graph);
    ...
    return {
        pathLen: head && state.appleNodeId ? (0, hamiltonian_certificate_js_1.distanceForwardOnCycle)(head, state.appleNodeId, candidateCycle) : null,
...
function scoreCycleFeatures(features, weights = exports.defaultCycleScoreWeights) {
...
function compareCandidateCycles(left, right, weights = exports.defaultCycleScoreWeights) {
