...
(0, testkit_1.describe)('Patch mutation scenario diagnostics', () => {
    (0, testkit_1.it)('scenario diagnostics are deterministic for fixed options', () => {
        const map = (0, rectangular_cycle_1.createRectangularSavedMap)({ id: 'scenario-4x4', name: 'Scenario 4x4', width: 4, height: 4 });
        const first = (0, patch_mutation_scenarios_1.analyzePatchMutationScenarios)(map, scenarioOptions);
        const second = (0, patch_mutation_scenarios_1.analyzePatchMutationScenarios)(map, scenarioOptions);
        strict_1.default.deepEqual(second, first);
    });
    (0, testkit_1.it)('setting a far apple changes currentPathLen', () => {
        const map = (0, rectangular_cycle_1.createRectangularSavedMap)({ id: 'scenario-4x4', name: 'Scenario 4x4', width: 4, height: 4 });
        const scenarios = (0, patch_mutation_scenarios_1.analyzePatchMutationScenarios)(map, scenarioOptions).scenarios;
    ...
    (0, testkit_1.it)('diagnostics include currentPathLen and best improvement', () => {
        const map = (0, rectangular_cycle_1.createRectangularSavedMap)({ id: 'scenario-4x4', name: 'Scenario 4x4', width: 4, height: 4 });
        const scenario = (0, patch_mutation_scenarios_1.analyzePatchMutationScenarios)(map, scenarioOptions).scenarios[0];
        ...
        strict_1.default.equal(typeof scenario.graphValidPatchCandidates, 'number');
        strict_1.default.equal(typeof scenario.snakeUsableCandidates, 'number');
    ...
    (0, testkit_1.it)('diagnostics do not mutate gameplay state', () => {
        ...
        (0, patch_mutation_scenarios_1.analyzePatchMutationScenario)(scenario, scenarioOptions);
        const after = JSON.stringify(scenario.state);
        strict_1.default.equal(after, before);
    });
    (0, testkit_1.it)('evaluates at least one controlled far-apple scenario even when no improvement is found', () => {
        const map = (0, rectangular_cycle_1.createRectangularSavedMap)({ id: 'scenario-4x4', name: 'Scenario 4x4', width: 4, height: 4 });
        const report = (0, patch_mutation_scenarios_1.analyzePatchMutationScenarios)(map, scenarioOptions);
