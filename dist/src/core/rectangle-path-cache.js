...
export function localIndex(x, y, width) {
    return y * width + x;
}
export function localCoord(index, width) {
    return {
        x: index % width,
        y: Math.floor(index / width)
    };
}
export function validateLocalHamiltonianPath(width, height, path, terminalA, terminalB) {
...
export function buildRectanglePathCache(options = {}) {
    return new RectanglePathCache(options);
}
export function getRectanglePaths(width, height, terminalA, terminalB, options = {}) {
