...
export function validateHamiltonianCycle(graphSnapshot, cycle) {
...
export function validateDraftMap(draft, options = {}) {
...
export function validateLoadedMap(savedMap, options = {}) {
    const startedAt = performance.now();
    const draft = {
        id: savedMap.id,
        name: savedMap.name,
