...
import { applyCertifiedPostAppleTransition, currentCyclePathLen, debugCertifiedSwitchSelection, getCertifiedLockedCycle } from './certified-cycle-controller.js';
import { generateDiverseHamiltonianCycles } from './cycle-library.js';
import { advanceGame } from './game-engine.js';
import { createInitialGameState } from './game-state.js';
import { appleForward, explainLockedCertificateFailure } from './hamiltonian-certificate.js';
...
export function renderCycleOverlay(state, cycle = getCertifiedLockedCycle(state)) {
...
export function collectCertifiedAppleEventLog(map, options = {}) {
...
export function formatCertifiedAppleEventLog(report) {
    const lines = [];
